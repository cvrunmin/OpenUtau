...
namespace OpenUtau.Core.Formats
{
    public static class Ust
    {
        ...
        static List<string> NoteToUst(UNote note, UstVersion version)
        {
            ...
            if (!note.Phonemes[0].AutoEnvelope || (int)note.Expressions["release"].Data > 0 || true)
            {
