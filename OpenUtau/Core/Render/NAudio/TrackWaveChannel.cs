...
{
    class TrackWaveChannel : WaveStream, ISampleNotifier
    {
        ...
        public TrackWaveChannel(WaveStream sourceStream, float volume, float pan)
        {
            PadWithZeroes = true;
        ...
        /// </summary>
        /// <param name="sourceStream">The source stream</param>
        public TrackWaveChannel(WaveStream sourceStream)
            :
