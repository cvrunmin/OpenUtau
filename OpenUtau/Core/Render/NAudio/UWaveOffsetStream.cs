...
{
    public class UWaveOffsetStream : WaveStream
    {
        ...
        /// <param name="startTime">the time at which we should start reading from the source stream, similer to Delay</param>
        /// <param name="sourceOffset">amount to trim off the front of the source stream, similer to Skip</param>
        /// <param name="sourceLength">length of time to play from source stream, similer to Take</param>
        public UWaveOffsetStream(WaveStream sourceStream, TimeSpan startTime, TimeSpan sourceOffset, TimeSpan sourceLength)
        {
        ...
        /// </summary>
        /// <param name="sourceStream">The source stream</param>
        public UWaveOffsetStream(WaveStream sourceStream)
